...
public class ControleCadastro {
         ...
         * controleReceita.cadastrarReceitas("Tapioca de queijo e presunto"
         * ,listaModoPreparo.get(4));controleReceita.cadastrarReceitas("Mingau",
         * listaModoPreparo.get(5));controleReceita.cadastrarReceitas("Cuscuz",
         * listaModoPreparo.get(6));controleReceita.cadastrarReceitas("Misto",
         * listaModoPreparo.get(7));controleReceita.cadastrarReceitas("Panqueca",
         * listaModoPreparo.get(8));controleReceita.cadastrarReceitas("Strogonoff",
         * listaModoPreparo.get(9));controleReceita.cadastrarReceitas("Feijoada",
         * listaModoPreparo.get(10));controleReceita.cadastrarReceitas("Feijão",
         * listaModoPreparo.get(11));controleReceita.cadastrarReceitas("Arroz",
         * listaModoPreparo.get(12));controleReceita.cadastrarReceitas("Macarrão",
         * listaModoPreparo.get(13));controleReceita.cadastrarReceitas("Pizza",
         * listaModoPreparo.get(14));controleReceita.cadastrarReceitas("Lasanha",
         * listaModoPreparo.get(15));controleReceita.cadastrarReceitas("Pudim",
         * listaModoPreparo.get(16));controleReceita.cadastrarReceitas("Pavê",
         * listaModoPreparo.get(17));controleReceita.
         * cadastrarReceitas("Mousse de maracujá",listaModoPreparo.get(18));
         ...
         * ;controleReceita.cadastrarReceitas("Misto com requeijão",listaModoPreparo.get
         * (24));controleReceita.cadastrarReceitas("Brigadeiro",listaModoPreparo.get(25)
         * );controleReceita.cadastrarReceitas("Arroz Carreteiro",listaModoPreparo.get(
         * 26));controleReceita.cadastrarReceitas("Frango Empanado com Creme de Leite"
         * ,listaModoPreparo.get(27));controleReceita.cadastrarReceitas("Salpicão",
         * listaModoPreparo.get(28));controleReceita.cadastrarReceitas("Carne",
         * listaModoPreparo.get(29));controleReceita.
         * cadastrarReceitas("Bife ao Molho Mostarda",listaModoPreparo.get(30));}
         * 
